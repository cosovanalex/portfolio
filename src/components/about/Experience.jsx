...
const experienceContent = [
  {
    ...
    details: `▪ Employed best coding practices and object-oriented programming techniques to work on different software development projects.
    ▪ Deployed 3 RESTful APIs using ReactJS and Flask in combination with PostgreSQL databases.
